...
function OnInit(s)
    ...
    filer=io.open("C:/QuikKITFinance/data/Test-1/test-"..SEC.."-light-"..dt..".txt", "a")
...
function main()
	...
	while true do
	  ...
	  if (qt.bid_count+0 == 0) or (qt.offer_count+0 == 0) or tm<1630 then
		  sleep(1000)
	  else
		break
	  end
		...
		wrk=1
    message(SEC.." light wrk : "..tostring(wrk)	, 1)
