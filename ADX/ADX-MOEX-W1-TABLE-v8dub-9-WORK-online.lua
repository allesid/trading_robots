...
if tw == "WORK" then
	...
	tn = ldd_1 * last_deal[SEC][8]
						...
						if ldd > ldd_1 then
							...
							message(SEC.." "..vers.." BYE  time="..tostring(tm).." lots="..tostring(ldd-ldd_1).." ldd="..tostring(ldd).." prc="..string.format('%.2f', prc).." res="..tostring(last_deal[SEC][2]).." pct="..tostring(last_deal[SEC][4]), 1)
						else
							...
							message(SEC.." "..vers.." SELL time="..tostring(tm).." lots="..tostring(ldd-ldd_1).." ldd="..tostring(ldd).." prc="..string.format('%.2f', prc).." res="..tostring(last_deal[SEC][2]).." pct="..tostring(last_deal[SEC][4]), 1)
						end
					end
...
function calc_ld(adx, pdi, mdi, a, ld)
	...
	elseif (adx < a[1] and a[1] > a[5]) then
		ld = 0
	end
	return ld
end
