...
price_partc = 0.1 -- то же для сделки закрытия позиции
ver = "v5-TEST" -- "WORK"
--  ========    DATA    ====================
...
function position_up(SEC, last_dealu)
	...
	if last_deal[SEC][1] < 0  then
		...
		if math.abs(res) > offS then
			...
			message(SEC, 1)
			message("res="..res, 1)
			message("last_deald[SEC][1]="..last_deal[SEC][1], 1)
			message("last_deald[SEC][2]="..last_deal[SEC][2], 1)
			message("last_deald[SEC][3]="..last_deal[SEC][3], 1)
			message("last_deald[SEC][4]="..last_deal[SEC][4], 1)
			message("last_deald[SEC][5]="..last_deal[SEC][5], 1)
			...
			filer_err:write(" ld_"..last_deal[SEC][1])
			filer_err:write(" res_"..last_deal[SEC][2])
			filer_err:write(" pos_"..last_deal[SEC][3])
			filer_err:write(" pospct_"..last_deal[SEC][4])
			filer_err:write(" prc_"..last_deal[SEC][5])
			filer_err:write('\n')
			filer_err:close()
		end
