		...
		if os.sysdate().min ~= tm_minute then
			...
			for tab_num, SEC in pairs(sec_list) do
				...
				for i=1, qsummax do 
					...
					SetCell(tb_res[tab_num], last_row, 2*j+3,  string.format('%.2f', qssumb20/i))
					if qssumb20 > 0 then
						SetColor(tb_res[tab_num], last_row, 2*j+3, RGB(160,255,160),RGB(0,0,0), RGB(160,255,160), RGB(0,0,0))
					elseif qssumb20 < 0 then
						SetColor(tb_res[tab_num], last_row, 2*j+3, RGB(255,160,160),RGB(0,0,0), RGB(255,160,160), RGB(0,0,0))
					else
						SetColor(tb_res[tab_num], last_row, 2*j+3, RGB(255,255,255), RGB(0,0,0), RGB(255,255,255), RGB(0,0,0))
					end
					prints(sec_list, last_deal[i])
				end
			end
