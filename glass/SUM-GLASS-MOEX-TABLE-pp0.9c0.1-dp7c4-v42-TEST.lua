...
qsummax = 20
dpart = 7 -- коэффициент превышения суммы объема бид и оффер для сделки открытия позиции
-- например: сумма бидов умноженная на dpart > суммы офферов - покупка
dpartc = 4 -- то же для сделки закрытия позиции

price_part = 0.9 -- цена выставления ордера между бид мин и бид макс в интервале [0.0-1.0]
